                                ...
                                <div className="card-body p-5">
                                    ...
                                    <form method="POST" onSubmit={handleSubmit}>
                                        <div className="form-outline mb-4">
                                            <input type="text" name="email" placeholder="Enter Email" className="form-control form-control-lg" onChange={handleChange} />
                                    ...
                                    <p className="text-center text-muted mt-5 mb-0">Don't you have an account? <a href="/register"
