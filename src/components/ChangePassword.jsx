                                    ...
                                    <div className="card-body p-5">
                                        ...
                                        <form method="POST" onSubmit={handleSubmit}>
                                            ...
                                            <div className="form-outline mb-4">
                                                <input type="password" name="cpassword" placeholder="Enter current Password" className="form-control form-control-lg" onChange={handleChange} />
                                                {validationErrors.cpassword && <span className="text-danger">{validationErrors.cpassword}</span>}
                                            </div>
                                            <div className="form-outline mb-4">
                                                <input type="password" name="npassword" placeholder="Enter New Password" className="form-control form-control-lg" onChange={handleChange} />
                                                {validationErrors.npassword && <span className="text-danger">{validationErrors.npassword}</span>}
                                            </div>
                                            <div className="form-outline mb-4">
                                                <input type="password" name="cnpassword" placeholder="Enter Confirm New Password" className="form-control form-control-lg" onChange={handleChange} />
                                                {validationErrors.cnpassword && <span className="text-danger">{validationErrors.cnpassword}</span>}
                                            </div>
                                            
                                            <button type="submit" className="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Change Password</button>
                                        </form>
